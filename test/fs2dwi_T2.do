...
redo-ifchange $SCRIPT ../scripts-pipeline/warp.sh 
...
out=$outdir/fs2dwi_T2 && rm -rf $out || true
run $SCRIPT $fs/mri $dwied $dwiedmask $t2 $origmask $t1align $alignmask $out
#verify $out/wmparc-in-bse.nrrd 4e0ff77364410c839a572f8cecb7b849
verify $out/wmparc-in-bse.nrrd dd291fbe3728f311e23e4adb8e7f8f84
